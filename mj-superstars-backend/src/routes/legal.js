...
PRIVACY POLICY
White Mike (MJ Superstars) Mental Wellness Companion

Last Updated: ${new Date().toLocaleDateString()}

1. INTRODUCTION
White Mike ("we", "us", "our", or "App") is committed to protecting your privacy. This Privacy Policy explains our data practices for the White Mike mobile application.
...
router.get('/privacy-policy-json', (req, res) => {
  res.json({
    ...
    appName: 'White Mike (MJ Superstars)',
