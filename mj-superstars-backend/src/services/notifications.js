...
if (process.env.VAPID_PUBLIC_KEY && process.env.VAPID_PRIVATE_KEY) {
  webPush.setVapidDetails(
    process.env.VAPID_SUBJECT || 'mailto:support@topperformer.com',
  ...
  async sendCheckIn(userId, type = 'daily') {
    const templates = {
      daily: {
        ...
        body: 'How are you feeling today? Coach Mike would love to hear from you.'
      },
      morning: {
      ...
      gentle: {
        ...
        body: "Just wanted to check in. Coach Mike is here whenever you need."
      },
      celebration: {
