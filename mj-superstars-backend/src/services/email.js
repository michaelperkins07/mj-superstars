...
<body>
  <div class="container">
    <div class="logo">
      <span class="logo-text">Perkins ⭐</span>
    </div>
    <div class="card">
    ...
    <div class="footer">
      <p>Perkins — Your AI coaching companion</p>
...
<body>
  ...
  const text = `Welcome to Perkins, ${name}!\n\nI'm Perkins, your personal AI coach. Everything is reps — every conversation, every mood you track, every task you crush adds up.\n\nStart by telling me what's on your mind. Let's get it!`;

  return sendEmail({
    to: email,
    subject: `Welcome to Perkins, ${name}! 🎉`,
    html,
    text
  });
}
